...
public static class EnemyTemplates
{
    static readonly EnemyTemplate ratTemplate = new EnemyTemplate(
        ...
        speed: 1.2f,
        worthFactor: 0.7f,
        new ActionFactory(() => new[] { new AttackRandomAction("Sprites/yellow_34", 5, new DamageConfig(5, 6)) })
        );
    ...
    static readonly EnemyTemplate mudGolemTemplate = new EnemyTemplate(
        ...
        speed: 0.5f,
        worthFactor: 1.5f,
        new ActionFactory(() => new[] { new AttackRandomAction("Sprites/yellow_34", 5, new DamageConfig(8, 12)) })
        );
    ...
    static readonly EnemyTemplate eyeBatTemplate = new EnemyTemplate(
        ...
        speed: 1.1f,
        worthFactor: 1f,
        new ActionFactory(() => new[] { new AttackRandomAction("Sprites/yellow_34", 5, new DamageConfig(3, 4)) })
        );
